<%@ Page Title="日期查詢" Language="C#" MasterPageFile="../MasterPage.master" Debug="true" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeFile="Date.aspx.cs" Inherits="Search_Date" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div align="center">        
        ...
        項目：
        <asp:DropDownList ID="SelItem" runat="server" ForeColor="Green">
            <asp:ListItem>所有欄位</asp:ListItem>
            <asp:ListItem>日誌班別</asp:ListItem>
            <asp:ListItem>日誌時間</asp:ListItem>
            <asp:ListItem>日誌存檔</asp:ListItem>
            <asp:ListItem>公告期限</asp:ListItem>
            <asp:ListItem>訊息時間</asp:ListItem>
            <asp:ListItem>訊息存檔</asp:ListItem>
            <asp:ListItem>處理時間</asp:ListItem>
            <asp:ListItem>處理存檔</asp:ListItem>
            <asp:ListItem>叫修存檔</asp:ListItem>
        </asp:DropDownList>&nbsp;&nbsp;&nbsp;&nbsp;

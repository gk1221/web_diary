...
<form id="form1" runat="server">
    <div id="divBody" align="center" style="width: 100%; overflow: auto;">
        ...
        <table>
            ...
            <tr>
                <td>第三機房熱通道最高　溫度：<asp:TextBox ID="txtTemp5" runat="server" ForeColor="Green" Width="40px" CssClass="style0" /></td>
                <td>&nbsp;&nbsp;溼度：<asp:TextBox ID="txtHumi5" runat="server" ForeColor="Green" Width="40px" CssClass="style0" /></td>
            </tr>
            <tr>
                <td>第三機房熱通道最低　溫度：<asp:TextBox ID="txtTemp6" runat="server" ForeColor="Green" Width="40px" CssClass="style0" /></td>
                <td>&nbsp;&nbsp;溼度：<asp:TextBox ID="txtHumi6" runat="server" ForeColor="Green" Width="40px" CssClass="style0" /></td>
            </tr>
            <tr>
                <td>第三機房冷通道最高　溫度：<asp:TextBox ID="txtTemp7" runat="server" ForeColor="Green" Width="40px" CssClass="style0" /></td>
                <td>&nbsp;&nbsp;溼度：<asp:TextBox ID="txtHumi7" runat="server" ForeColor="Green" Width="40px" CssClass="style0" /></td>
            </tr>
            <tr>
                <td>第三機房冷通道最低　溫度：<asp:TextBox ID="txtTemp8" runat="server" ForeColor="Green" Width="40px" CssClass="style0" /></td>
                <td>&nbsp;&nbsp;溼度：<asp:TextBox ID="txtHumi8" runat="server" ForeColor="Green" Width="40px" CssClass="style0" /></td>
            </tr>			
        </table>
        <br />

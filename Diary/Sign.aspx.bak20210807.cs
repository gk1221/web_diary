...
public partial class Diary_Sign : System.Web.UI.Page
{
    ...
    protected void BtnSave_Click(object sender, EventArgs e)  //存檔
    {
        ...
        ExecDbSQL("insert into [diary] values('" + tour + "',0,'" + DiaryDT + "','" + nowDT + "',0,'',0,'***','f')");
        ...
        string strTH =     "第一機房最高：溫度:" + txtTemp1.Text + "　溼度:" + txtHumi1.Text
                       ...
                       + "　第二機房最高：溫度:" + txtTemp3.Text + "　溼度:" + txtHumi3.Text
        ...
        else
        {
            ...
            if (SopMsg != "")
            {
                ...
                ExecDbSQL("insert into [Diary] values('" + tour + "'," + DiaryNo + ",'" + DiaryDT + "','" + nowDT + "',0,'',0,'992','d')");
